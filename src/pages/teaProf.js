...
export default function teaProf() {
  return (
    <div>
      <p className="wel">Welcome</p>
      <img src={profile} alt="Profile" id="prof" />
      <Link to="/teaDash">
        <img src={homeIcon} alt="Home Icon" id="ho" />
      </Link>
      <div className="stuProfile">
        ...
        <button type='update' className="btnupdate" id='teaupdate' name='Update' value='Update'>Update</button>
      </div>
    </div>
  );
}
